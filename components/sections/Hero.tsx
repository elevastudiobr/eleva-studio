  ...
  return (
    <section className="eleva-background relative flex min-h-screen overflow-hidden bg-[#050817]">
      ...
      {/* =========================
          MOCKUP — MOBILE
      ========================= */}
      <div className="pointer-events-none absolute right-[-38%] top-[27%] z-0 w-[105%] sm:right-[-32%] sm:top-[25%] sm:w-[100%] md:hidden">
      ...
      {/* =========================
          MOCKUP — DESKTOP
      ========================= */}
      <div className="pointer-events-none absolute right-[-2%] top-1/2 z-0 hidden -translate-y-1/2 lg:block xl:right-[2%]">
      ...
      <div className="relative z-30 mx-auto flex min-h-screen w-full max-w-7xl items-center px-6 pb-20 pt-28 md:px-12 md:pt-32 lg:px-20">
        ...
        <div className="max-w-3xl">
          ...
          {/* Headline */}
          <h1 className="max-w-[650px] text-[clamp(3.4rem,12vw,5.5rem)] font-medium leading-[0.9] tracking-[-0.065em] text-white md:text-[clamp(4rem,8vw,6rem)] lg:text-[clamp(3.5rem,7vw,7rem)]">
          ...
          {/* Descrição */}
          <p className="mt-9 max-w-lg text-sm leading-[1.75] text-[#a5a7b5] md:mt-12 md:text-base lg:text-lg">
          ...
          <Link
            href="#projetos"
            className="group mt-7 flex w-fit items-center gap-3 rounded-full bg-[#5b55ff] px-5 py-3.5 text-sm font-medium text-white transition-all duration-300 hover:-translate-y-1 hover:bg-[#706bff] md:mt-9 md:px-6"
          >
            Explorar projetos
      ...
      {/* =========================
          INDICADOR INFERIOR
      ========================= */}
      <div className="absolute bottom-7 left-6 z-40 flex items-center gap-3 text-[9px] uppercase tracking-[0.22em] text-[#6f7282] md:left-12 md:text-[10px] md:tracking-[0.25em] lg:left-20">
      ...
      {/* =========================
          SCROLL
      ========================= */}
      <div className="absolute bottom-7 right-6 z-40 hidden items-center gap-3 text-[10px] uppercase tracking-[0.25em] text-[#6f7282] md:right-12 md:flex lg:right-20">
